...
- **Quiz** (dentro do `/gbj/`, segunda modalidade): pergunta de múltipla escolha, gerais (Igreja, Carmelo, Paróquia, Liturgia...) e dos livros do ano — Tobias, Evangelho de João, Efésios (227 perguntas ao todo — 200 vieram de dois documentos do grupo, mais 27 escritas por revisão direta e conferidas uma a uma, cada uma com a fonte anotada em comentário no arquivo — ver `gbj/quiz/perguntas.js`). Começa com 5 vidas, mesma lógica de tempo escolhido por quem treina (a prova nem define um tempo fixo pro Quiz, aqui o padrão é "sem limite"). Boa parte das perguntas foi digitada à mão pelo grupo a partir dos documentos oficiais, e o gabarito pode ter erro de transcrição — por isso cada pergunta tem um botão **"Contestar esta pergunta"**, que avisa o coordenador (aba GBJ do painel) sem travar o treino de quem está jogando.
