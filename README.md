...
- **Quiz** (dentro do `/gbj/`, segunda modalidade): pergunta de múltipla escolha, gerais (Igreja, Carmelo, Paróquia, Liturgia...) e dos livros do ano — Tobias, Evangelho de João, Efésios (200 perguntas ao todo, 50 por seção, vindas de dois documentos diferentes — ver `gbj/quiz/perguntas.js`). Começa com 5 vidas, mesma lógica de tempo escolhido por quem treina (a prova nem define um tempo fixo pro Quiz, aqui o padrão é "sem limite"). As perguntas foram digitadas à mão pelo grupo a partir do documento oficial, e o gabarito pode ter erro de transcrição — por isso cada pergunta tem um botão **"Contestar esta pergunta"**, que avisa o coordenador (aba GBJ do painel) sem travar o treino de quem está jogando.
